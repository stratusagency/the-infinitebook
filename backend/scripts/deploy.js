...
async function main() {
    const contract = await hardhat_1.ethers.getContractFactory("Book");
    const interactContract = await contract.deploy();
    await interactContract.deployed();
    await interactContract
        .writeMessage("0x375CA6c10a447e9F465d5Ed90d4C9CF53Ab35B1E", "hello world, this is stratusagency.eth!")
